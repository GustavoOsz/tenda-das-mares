...
<body class="bg-white text-[#4f2905] font-sans">
  ...
  <main class="max-w-6xl mx-auto mt-12 grid grid-cols-1 md:grid-cols-3 gap-8 px-6">
    ...
    <div class="flex flex-col gap-8">
      ...
      <div class="bg-[#fde9c7] p-6 rounded-2xl shadow-lg">
        <h3 class="text-xl font-semibold mb-3">Sobre Gustavo</h3>
        <p id="pessoal1" class="typing text-base leading-relaxed"></p>
      </div>

      <div class="bg-[#fde9c7] p-6 rounded-2xl shadow-lg">
        <h3 class="text-xl font-semibold mb-3">Sobre Maria</h3>
  ...
  <script>
    ...
    const pessoal1Txt = "Olá! Meu nome é Gustavo, sou apaixonado por cultura, tradições e espiritualidade. Essa loja representa muito da minha caminhada pessoal e profissional.";
    const pessoal2Txt = "Oie! Me chamo Maria Eduarda e o meu sonho é mostrar para os mais jovens que eles podem viver sua cutura e sua espiritualidade aonde eles quiserem! E o Tenda das Marés é um exemplo disso, por isso que sou apaixonada nesse projeto.";
